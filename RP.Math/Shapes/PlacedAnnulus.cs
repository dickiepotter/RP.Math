namespace RP.Math
{
    ...
    public struct PlacedAnnulus : IEquatable<PlacedAnnulus>, IFormattable
    {
        ...
        /// <summary>
        /// Intersect the filled ring with an infinite <see cref="Line"/>. A line meets the flat ring at most
        /// once, so on a hit <paramref name="near"/> and <paramref name="far"/> are the same crossing point.
        /// </summary>
